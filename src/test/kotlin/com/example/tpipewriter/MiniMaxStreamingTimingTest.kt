 ...
 *
 * The test fails (with diagnostic output) if all chunks arrive within
 * less than 100ms of each other — which would indicate the model is
 * responding with a single big delta instead of streaming.
 *
...
class MiniMaxStreamingTimingTest {
    ...
    fun testChunksArriveIncrementally() {
        ...
        if (chunks.size >= 2) {
            // Print inter-chunk timing distribution.
            ...
            // Diagnostic: count chunks that are large vs small.
